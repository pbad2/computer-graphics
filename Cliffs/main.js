...
function computeVertexNormals(terrain, gridSize) {
    ...
    for (let i = 0; i < numRows; i++) {
        for (let j = 0; j < numCols; j++) {
            ...
            // console.log("math sub e+w", w,e )
            // console.log("math sub n+s", n)
...
function draw(milliseconds) {
    ...
    gl.uniform4fv(program.uniforms.color, [0.82, 0.71, 0.58, 1])

    gl.uniform3fv(program.uniforms.lightdir, math.normalize([0, 0, 1]))
    ...
    gl.uniform3fv(program.uniforms.camera_position, math.normalize(camera_position))
